Template.channelloginsteem.rendered = () => Template.settingsdropdown.nightMode()
Template.channelloginsteem.helpers({
    users: function() {
  ...
  Template.channelloginsteem.success = function(activeUsername, noreroute) {
  ...
  Template.channelloginsteem.events({
